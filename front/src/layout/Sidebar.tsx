  ...
  return (
    <aside className='w-[350px] mr-4 h-screen border-r border-gray-200 '>
        <div className='flex flex-col gap-4 h-full '>
          ...
          <div className='w-full my-4 space-y-3 px-3 '>
            ...
            <div className='flex items-center border border-gray-200 px-3 gap-3 '>
              <IoSearch onClick={() => refetch()} />
              <input 
                type='search' 
                value={search}
                onChange={(e) => setSearch(e.target.value)}
                className='w-full  rounded-2xl py-2  outline-hidden '
                ...
                {friendsData?.length === 0 ? (
                    ...
                    <div className=' '>
                      {friendsData?.map((friend) => (
                        <div key={friend._id} className='flex items-center gap-4 py-4 w-full px-3 cursor-pointer hover:bg-gray-200 '>
                          <img 
